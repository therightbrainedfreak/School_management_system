    ...
    return (
        <div className='mx-4'>
                    ...
                    <button onClick={()=>{publishBlog()}} className='cursor-pointer flex flex-row items-center justify-center gap-1 bg-green-200 px-3 py-2 rounded-md select-none w-25'>
                        {
                            isPublishing
                                ? <Loader />
                                : <div className='flex flex-row items-center justify-center gap-1'><MdOutlinePublish size={"18px"} />Publish</div>
                        }
                    </button>
                </div>
            </nav>
            ...
            <div className='py-2 flex flex-col gap-2'>
                ...
                <BlogEditor onChange={setContent} value={content} setFocus={setContentFieldFocus} setError={setContentError} />
            </div>
